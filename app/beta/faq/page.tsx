...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "What are the plans?", a: "7-Day Free Access ($0) — a 7-day trial of the invite-only indicator, added manually after review. RangeClarity Beta ($29/mo) — the main paid beta with the full invite-only indicator. RangeClarity Pro Beta ($49/mo) — everything in RangeClarity Beta plus priority manual access review, priority support/feedback, and early feature previews when available." },
  { q: "What does RangeClarity Pro Beta ($49/mo) give me?", a: "Higher-intent support: priority access review, priority support and feedback, early feature previews, and the private feedback channel when available. It does not give better trades, better performance, signals, or any profit advantage — it is the same structure tool with priority service." },
