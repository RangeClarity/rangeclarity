...
a1+=`<rect x="160" y="322" width="770" height="56" rx="28" fill="rgba(12,19,34,0.6)" stroke="${C.line2}"/>`;
...
a1+=T(160,500,'TradingView indicators',{size:112,w:800,fill:'#ffffff',ls:-3});
a1+=T(160,612,'that show the',{size:112,w:800,fill:'#ffffff',ls:-3});
a1+=T(160,724,'range before you',{size:112,w:800,fill:'url(#grad)',ls:-3});
a1+=T(160,836,'make the move.',{size:112,w:800,fill:'url(#grad)',ls:-3});
...
a4+=T(W/2,300,'Three modules. One clear call.',{size:78,w:800,fill:'#ffffff',anchor:'middle',ls:-2});
...
a6+=`<rect x="${Cx-250}" y="${cardY+70}" width="500" height="52" rx="26" fill="rgba(52,245,176,0.1)" stroke="${C.green}55"/>`;
a6+=`<circle cx="${Cx-200}" cy="${cardY+96}" r="7" fill="${C.green}"/>`+T(Cx+20,cardY+105,'EARLY ACCESS &#183; LIMITED SEATS',{size:22,fill:C.green,mono:true,ls:3,anchor:'middle'});
a6+=T(Cx,cardY+250,'Stop chasing candles.',{size:78,w:800,fill:'#ffffff',anchor:'middle',ls:-2});
a6+=T(Cx,cardY+345,'Start reading the range.',{size:78,w:800,fill:'url(#grad)',anchor:'middle',ls:-2});
